...
def main(seed=1, num_trials=10, fast=False, out_dir=None, pivot_hours=100.0,
    ...
    # config_dual_phase_baseline_time (and everything it transitively imports) is EVER imported
    # in this process -- hence get_config is imported here, deferred, instead of at module level
