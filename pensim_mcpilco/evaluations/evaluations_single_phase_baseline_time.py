...
from mcpilco.config_single_phase_baseline_time import get_config as baseline_get_config

BASELINE_RESULTS_ROOT = Path(_ROOT) / "results" / "single_phase_baseline_time"
...
if __name__ == "__main__":
    ...
    p.add_argument("--results_root", type=str, default=None,
                   help="override the results root run_id is resolved under "
                        "(default: results/single_phase_baseline_time/)")
    args = p.parse_args()
