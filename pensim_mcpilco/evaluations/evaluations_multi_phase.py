...
def main(run_id, gp_trial=None, n_eval_seeds=5, eval_base=700000, compare_seed=None):
    ...
    lib.plot_multistep_rollout(gp_agent, gp_idx, ho_idx, has_ho, out_dir, run.pivot_hours, show=False)
    lib.plot_particle_bands(gp_agent, gp_idx, ho_idx, has_ho, out_dir, run.pivot_hours, show=False)
    lib.plot_calibration(gp_agent, gp_idx, ho_idx, has_ho, out_dir, show=False)
    lib.plot_local_error(gp_agent, gp_idx, ho_idx, has_ho, out_dir, run.pivot_hours, show=False)
